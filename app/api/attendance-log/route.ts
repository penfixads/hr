...
import { updateAttendanceLog, deleteAttendanceLog } from '@/lib/attendance'
import { PUNCH_SEQUENCE, type PunchType } from '@/lib/attendance-shared'

// Admin-only correction/removal of a single attendance_logs punch — see
// components/AttendancePunchRowActions.tsx for the UI and
// attendance/supabase/migrations/052_attendance_admin_edit_delete.sql for the RLS this
// depends on (must be copied into penfixads-OS and run there, per that file's header).
//
